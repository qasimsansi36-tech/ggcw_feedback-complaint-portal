...
<h2 style="margin-top:0; color:#111827; font-size:18px;">✅ Aap ka account approve ho gaya hai!</h2>
...
<p style="color:#374151; font-size:15px; line-height:1.6;">
Aap ki registration request GGCW Complaint &amp; Feedback Portal ke admin ne <strong>approve</strong> kar di hai.
Ab aap apne account (<strong>{{ ucfirst($user->role) }}</strong>) se login kar sakte hain.
</p>
...
<a href="{{ rtrim(env('FRONTEND_URL', 'https://ggcwcomplaints.com'), '/') }}/login.html"
...
Agar aap ne ye registration khud nahi ki thi, to baraye meherbani apni institution ke administration office se rabta karein.
</p>
</td>
</tr>
